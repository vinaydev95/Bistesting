        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="bg-yellow-500 text-blue-900 px-8 py-4 rounded-lg hover:bg-yellow-400 transition-colors font-semibold text-lg flex items-center justify-center">
                Request A Quote
              </button>
              <button className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white hover:text-blue-900 transition-colors font-semibold text-lg flex items-center justify-center">
